...
#define GPS_UART_DEVICE_ID     XPAR_PS7_UART_1_DEVICE_ID
#define GPS_UART_INT_IRQ_ID    XPAR_XUARTPS_1_INTR

extern struct uartIRQcallback uartIRQCallbackRef;


//#define UART_RX_IRQ_MASK  ( XUARTPS_IXR_RXOVR | XUARTPS_IXR_TOUT | XUARTPS_IXR_RXFULL)
#define UART_RX_IRQ_MASK  (XUARTPS_IXR_TOUT)
